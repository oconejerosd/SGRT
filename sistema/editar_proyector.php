<?php
	...
	$sql = mysqli_query($conection,"SELECT  e.id_equ,te.nom_tipe, mo.nom_mod, ma.nom_mar, e.ip_equ, e.ser_equ,
											e.fadq_equ,e.gtia_equ,e.usuarioi_equ,e.passi_equ
    FROM equipos e 
...
<head>
	...
	?>
	<title>Actualizar Proyector</title>
</head>
<body>
<?php include "includes/header.php";	?>
	<section id="container">
		<div class="form_register">
			<h1>Actualizar Proyector</h1>
			<hr>
			...
			<form action="" method="POST">
				...
				<input type="submit" value="ACTUALIZAR PROYECTOR" class="btn_grabar">
			</form>
		</div>
	</section>
