...
<head>
	...
	?>
	<title>MANTENCION IMPRESORA</title>
</head>
<body>
<?php include "includes/header.php";	?>
	<section id="container">
		<h1><i class="fas fa-print"></i> MANTENCIÓN IMPRESORA</h1>
        <?php
           if (!isset($_POST['buscar'])) {
            ...
            WHERE e.id_tipe = 3 AND estatus_equ = 1 AND asig_equ = 0";
                        ...
                        <tbody>
                            ...
                            while ($row= mysqli_fetch_array($sql_query)){?>
                                <tr>
                                    ...
                                    <td><?= $row['ser_equ']?></td>
                                    <td>
                                         <a class ="link_edit" href="reparacion_impresora.php?id=<?php echo $row["id_equ"]  ?>"><i class="fas fa-tools"></i> Mantención</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
