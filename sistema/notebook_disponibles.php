...
<head>
	...
	?>
	<title>NOTEBOOKS DISPONIBLES</title>
</head>
<body>
<?php include "includes/header.php";	?>
	<section id="container">
		<h1><i class="fas fa-laptop"></i> NOTEBOOK DISPONIBLES</h1>
        <?php
                        ...
                        <tbody>
                            ...
                            while ($row= mysqli_fetch_array($sql_query)){?>
                                <tr>
                                    ...
                                    <td><?= $row['ser_equ']?></td>
                                    <td>
                                         <a class ="link_edit" href="asignar_notebooks.php?id=<?php echo $row["id_equ"]  ?>"><i class="fas fa-edit"></i> Asignar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
