		...
		if(empty($_POST['idNote']))
		{
			...
			if($query_insert){
				...
				$sql_est_mant = mysqli_query($conection,"UPDATE equipos 
														 SET mant_equ = '1' 
														 WHERE id_equ ='$idNote'");
				header('location:reporte_mant_notebook.php');
			}else{
...
<head>
	...
	?>
	<title>REPARACIÓN NOTEBOOK</title>
</head>
<body>
<?php include "includes/header.php";	?>
	<section id="container">
		<div class="form_register">
			<h1>Reparación Notebook</h1>
			<hr>
			...
			<form action="" method="POST">
				...
				<label for="detalle">Detalle Solicitud</label><br>
				<textarea name="detalle" id="detalle" cols="58" rows="5" placeholder="Detalle de la solicitud"></textarea>
				<input type="submit" value="INGRESO REPARACIÓN" class="btn_grabar">
			</form>
		</div>
	</section>
