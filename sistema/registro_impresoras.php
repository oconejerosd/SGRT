	...
	if(!empty($_POST))
	{
		...
		if(empty($_POST['serie']) || empty($_POST['fadquisicion']) || empty($_POST['garantia'])|| empty($_POST['ip']))
		{
			...
			if($result>0){
				...
				VALUES 
				('$serie', '$fadquisicion','$garantia', '$usuarioi', '$passi', '$ip', 3 , '$marca', '$modelo','$departamento','$idrole');");
...
<head>
	...
	?>
	<title>Registro Impresoras</title>
</head>
<body>
<?php include "includes/header.php";	?>
	<section id="container">
		<div class="form_register">
			...
			<h1><i class="fas fa-print"></i> Registro Impresoras</h1>
			<hr>
			...
			<form action="" method="POST">
				...
				<label for="garantia">Garantía Impresora</label>
				...
				<input type="text" name="ip" id="ip" placeholder="IP Impresora">
				...
				<input type="submit" value="REGISTRO IMPRESORA" class="btn_grabar">
			</form>
		</div>
