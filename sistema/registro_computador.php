	...
	if(!empty($_POST))
	{
		...
		if(empty($_POST['serie']) || empty($_POST['fadquisicion']) || empty($_POST['garantia'])|| empty($_POST['ip']))
		{
			...
			if($result>0){
				...
				VALUES 
				('$serie', '$licwin','$licoffice','$fadquisicion','$garantia', '$ip', 2 , '$marca', '$modelo','$departamento','$idrole');");
...
<head>
	...
	?>
	<title>Registro Computadores</title>
</head>
<body>
<?php include "includes/header.php";	?>
	<section id="container">
		<div class="form_register">
			...
			<h1><i class="fas fa-desktop"></i> Registro Computadores</h1>
			<hr>
			...
			<form action="" method="POST">
				...
				<input type="text" name="ip" id="ip" placeholder="IP Computador">
				...
				<input type="submit" value="REGISTRO COMPUTADOR" class="btn_grabar">
			</form>
		</div>
